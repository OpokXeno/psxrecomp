...
/* v15: generated stores call psx_store_cycle_barrier() before any host-visible
 *      write or SWL/SWR read-modify-write.  The barrier flushes ABI v11's
 *      DLL-local pending cycles so MMIO, self-modification, and capture hooks
 *      observe the exact post-instruction guest clock. */
 ...
 *      read/write side effects (SB/SH/SW/SWL/SWR/SWC2). */
#define PSX_OVERLAY_CODEGEN_VER 6
