...
/* v15: ws_depth_bound forwarder for configured aspect-scaled far-bound sites.
 *      Appended last; the fallback preserves the original immediate. */
 ...
 *   6: + configured negsub, masked-16-bit screen-X, and depth cull emits. */
