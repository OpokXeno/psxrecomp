...
uint32_t overlay_codegen_config_hash(const GameConfig& c) {
    ...
    h.words("cull_semantic_screen_bias",
            c.ws_cull_semantic_screen_bias_sites);
    h.words("cull_semantic_world_range",
            c.ws_cull_semantic_world_range_sites);
    h.words("cull_semantic_left_edge",
            c.ws_cull_semantic_left_edge_sites);
    h.words("cull_semantic_masked_screen_x",
            c.ws_cull_semantic_masked_screen_x_sites);
    h.words("cull_semantic_frustum_plane_x",
            c.ws_cull_semantic_frustum_plane_x_sites);
    h.words("cull_semantic_signed_screen_x",
            c.ws_cull_semantic_signed_screen_x_sites);
    h.words("cull_semantic_depth_bound",
            c.ws_cull_semantic_depth_bound_sites);
    h.words("cull_semantic_xclip_bound",
            c.ws_cull_semantic_xclip_bound_sites);
